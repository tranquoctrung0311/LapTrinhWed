  ...
  <body>
    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"]) && $_POST["action"] == "create") {
            ...
            $query = "INSERT INTO product (ProductName, SalePrice, CategoryName, ImageLink, ProductLink) VALUES ('$productName', '$salePrice', '$categoryName', '$imageLink', '$productLink')";
            
            if ($conn->query($query) === TRUE) {
                echo "<p class='text-success'>Đã đăng tin thành công.</p>";
            } else {
                echo "<p class='text-danger'>Có lỗi xảy ra khi đăng tin: " . $conn->error . "</p>";
            }
